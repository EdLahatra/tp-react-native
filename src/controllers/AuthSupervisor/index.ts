...
type NavigationProps = StackNavigationProp<StackParams, 'AuthSupervisor'>;

type Route = RouteProp<StackParams, 'AuthSupervisor'>;
...
export default class AuthController extends React.Component<Props, State> {
