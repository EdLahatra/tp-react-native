export default {
  ...
  CREATE TABLE IF NOT EXISTS Articles(
    ...
    [a_horo_modification] [nvarchar](25) NULL,
    [d_actif] [nvarchar](25) NULL,
    [article_pv_ttc] [nvarchar](25) NULL,
    [article_reference] [nvarchar](25) NULL,
    [article_reference_libelle] [nvarchar](25) NULL,
    [article_reference_coloris] [nvarchar](25) NULL,
    [article_code_article] [varchar](45) NULL,
    [article_statut] [nvarchar](25) NULL,
    [article_enseigne] [varchar](23) NULL,
    [article_designation] [nvarchar](70) NULL,
    ...
    [article_bonnet_designation] [nvarchar](22) NULL,
    [article_message_deballage] [nvarchar](150) NULL,
    [article_theme_designation] [varchar](25) NULL,
    [article_TVA] [varchar](20) NULL,
    [article_devise] [varchar](25) NULL
  );
  `,
