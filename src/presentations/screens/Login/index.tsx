...
import { View, Text, TouchableOpacity, NativeSyntheticEvent, NativeTouchEvent, Image, KeyboardAvoidingView, TextInput } from 'react-native';
...
import HomeScreen from './keyBoard';
  ...
  return (
    ...
    <KeyboardAvoidingView style={styles.verticalStyle}>
      ...
      <View style={styles.autocompleteContainer}>
       ...
       />
       <View
          style={{ zIndex: 10, backgroundColor: 'white', elevation:1 , paddingLeft: 10 }}
        >
          {
